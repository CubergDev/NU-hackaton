...
export const OFFICE_COORDS: Record<string, [number, number]> = {
  ...
  'Актау':             [43.6417, 51.2000],
  'Петропавловск':     [54.8750, 69.1611],
...
const KZ_CITY_FALLBACK: Record<string, [number, number]> = {
  ...
  'астана':      [51.1801, 71.4460],
  'нур-султан':  [51.1801, 71.4460],
  'нурсултан':   [51.1801, 71.4460],
  'шымкент':     [42.3417, 69.5901],
  'атырау':      [47.1167, 51.8833],
  'актобе':      [50.2797, 57.2073],
  'павлодар':    [52.2873, 76.9674],
...
export async function geocodeAddress(
  ...
  if (city || street) {
    try {
      const query = [street, house, city, 'Kazakhstan'].filter(Boolean).join(', ')
